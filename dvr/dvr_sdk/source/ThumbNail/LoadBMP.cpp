...
static int ReadFileInfoHead(FILE* f, BMPIMAGE * img){
...
static int WriteFileHeader(FILE* f, BMPIMAGE * in_img, BITDATATYPE bit_data_type)
{
    unsigned char header[BMP_SIZE_FILEHEADER];
...
static int WriteFileInfoHead(FILE* f, BMPIMAGE * in_img, BITDATATYPE bit_data_type){
